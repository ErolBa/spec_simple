...
subroutine init_outfile
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  H5CALL( sphdf5, h5open_f, (hdfier), sphdf5.f90, 108)

  ! (en/dis)able HDF5 internal error messages; sphdf5 has its own error messages coming from the macros
  H5CALL( sphdf5, h5eset_auto_f, (internalHdf5Msg, hdfier), sphdf5.f90, 111)

  ! Create the file
  H5CALL( sphdf5, h5fcreate_f, (trim(ext)//".sp.h5", H5F_ACC_TRUNC_F, file_id, hdfier ), sphdf5.f90, 114 )

  ! write version number
  HWRITERV_LO( file_id, 1, version, (/ version /), sphdf5.f90, 117)
  H5DESCR_CDSET( /version, version of SPEC,        sphdf5.f90, 118)
...
subroutine mirror_input_to_outfile
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  HDEFGRP( file_id, input, grpInput,                        sphdf5.f90, 144 )
  H5DESCR( grpInput, /input, group for mirrored input data, sphdf5.f90, 145 )
...
! they go into ext.h5/input/physics
  ...
  HDEFGRP( grpInput, physics, grpInputPhysics,                                                                                         sphdf5.f90, 155)
  H5DESCR( grpInputPhysics, /input/physics, physics inputs,                                                                            sphdf5.f90, 156)

  HWRITEIV_LO( grpInputPhysics,         1, Igeometry  , (/ Igeometry      /),                                                          sphdf5.f90, 158)
  H5DESCR_CDSET( /input/physics/Igeometry, geometry identifier,                                                                        sphdf5.f90, 159)
  HWRITEIV_LO( grpInputPhysics,         1, Istellsym  , (/ Istellsym      /),                                                          sphdf5.f90, 160)
  H5DESCR_CDSET( /input/physics/Istellsym, stellarator symmetry flag,                                                                  sphdf5.f90, 161)
  HWRITEIV_LO( grpInputPhysics,         1, Lfreebound , (/ Lfreebound     /),                                                          sphdf5.f90, 162)
  H5DESCR_CDSET( /input/physics/Lfreebound, free boundary flag,                                                                        sphdf5.f90, 163)
  HWRITERV_LO( grpInputPhysics,         1, phiedge    , (/ phiedge        /),                                                          sphdf5.f90, 164)
  H5DESCR_CDSET( /input/physics/phiedge, total enclosed toroidal magnetic flux,                                                        sphdf5.f90, 165)
  HWRITERV_LO( grpInputPhysics,         1, curtor     , (/ curtor         /),                                                          sphdf5.f90, 166)
  H5DESCR_CDSET( /input/physics/curtor, total enclosed toroidal current,                                                               sphdf5.f90, 167)
  HWRITERV_LO( grpInputPhysics,         1, curpol     , (/ curpol         /),                                                          sphdf5.f90, 168)
  H5DESCR_CDSET( /input/physics/curpol, total enclosed poloidal current,                                                               sphdf5.f90, 169)
  HWRITERV_LO( grpInputPhysics,         1, gamma      , (/ gamma          /),                                                          sphdf5.f90, 170)
  H5DESCR_CDSET( /input/physics/gamma, adiabatic index,                                                                                sphdf5.f90, 171)
  HWRITEIV_LO( grpInputPhysics,         1, Nfp        , (/ Nfp            /),                                                          sphdf5.f90, 172)
  H5DESCR_CDSET( /input/physics/Nfp, number of stellarator field periods,                                                              sphdf5.f90, 173)
  HWRITEIV_LO( grpInputPhysics,         1, Nvol       , (/ Nvol           /),                                                          sphdf5.f90, 174)
  H5DESCR_CDSET( /input/physics/Nvol, number of volumes,                                                                               sphdf5.f90, 175)
  HWRITEIV_LO( grpInputPhysics,         1, Mpol       , (/ Mpol           /),                                                          sphdf5.f90, 176)
  H5DESCR_CDSET( /input/physics/Mpol, maximum poloidal mode number,                                                                    sphdf5.f90, 177)
  HWRITEIV_LO( grpInputPhysics,         1, Ntor       , (/ Ntor           /),                                                          sphdf5.f90, 178)
  H5DESCR_CDSET( /input/physics/Ntor, maximum toroidal mode number,                                                                    sphdf5.f90, 179)
  HWRITEIV_LO( grpInputPhysics,      Mvol, Lrad       ,      Lrad(1:Mvol)   ,                                                          sphdf5.f90, 180)
  H5DESCR_CDSET( /input/physics/Lrad, degree of radial Chebychev polynomials,                                                          sphdf5.f90, 181)
  HWRITEIV_LO( grpInputPhysics,         1, Lconstraint, (/ Lconstraint    /),                                                          sphdf5.f90, 182)
  H5DESCR_CDSET( /input/physics/Lconstraint, type of constraint to enforce,                                                            sphdf5.f90, 183)
  HWRITEIV_LO( grpInputPhysics,         1, Lreflect,    (/ Lreflect       /),                                                          sphdf5.f90, 184)
  H5DESCR_CDSET( /input/physics/Lreflect, whether to reflect the perturbation on both boundaries for slab geometry                     sphdf5.f90, 185)
  HWRITERV_LO( grpInputPhysics,      Mvol, tflux      ,     tflux(1:Mvol)   ,                                                          sphdf5.f90, 186)
  H5DESCR_CDSET( /input/physics/tflux, toroidal magnetic flux in volumes,                                                              sphdf5.f90, 187)
  HWRITERV_LO( grpInputPhysics,      Mvol, pflux      ,     pflux(1:Mvol)   ,                                                          sphdf5.f90, 188)
  H5DESCR_CDSET( /input/physics/pflux, poloidal magnetic flux in volumes,                                                              sphdf5.f90, 189)
  HWRITERV_LO( grpInputPhysics,      Nvol, helicity   ,  helicity(1:Nvol)   ,                                                          sphdf5.f90, 190)
  H5DESCR_CDSET( /input/physics/helicity, helicity profile,                                                                            sphdf5.f90, 191)
  HWRITERV_LO( grpInputPhysics,         1, pscale     , (/ pscale         /),                                                          sphdf5.f90, 192)
  H5DESCR_CDSET( /input/physics/pscale, scaling factor for pressure,                                                                   sphdf5.f90, 193)
  HWRITERV_LO( grpInputPhysics,      Nvol, pressure   ,  pressure(1:Nvol)   ,                                                          sphdf5.f90, 194)
  H5DESCR_CDSET( /input/physics/pressure, pressure profile,                                                                            sphdf5.f90, 195)
  HWRITEIV_LO( grpInputPhysics,         1, Ladiabatic , (/ Ladiabatic     /),                                                          sphdf5.f90, 196)
  H5DESCR_CDSET( /input/physics/Ladiabatic, adiabatic flag,                                                                            sphdf5.f90, 197)
  HWRITERV_LO( grpInputPhysics,      Mvol, adiabatic  , adiabatic(1:Nvol)   ,                                                          sphdf5.f90, 198)
  H5DESCR_CDSET( /input/physics/adiabatic, adiabatic profile (?),                                                                      sphdf5.f90, 199)
  HWRITERV_LO( grpInputPhysics,  (1+Nvol), mu         ,        mu(1:Mvol)   ,                                                          sphdf5.f90, 200)
  H5DESCR_CDSET( /input/physics/mu, Beltrami parameter{,} parallel current profile,                                                    sphdf5.f90, 201)
  HWRITERV_LO( grpInputPhysics,  (1+Nvol), Ivolume    ,   Ivolume(1:Mvol)   ,                                                          sphdf5.f90, 202)
  H5DESCR_CDSET( /input/physics/Ivolume, Volume current{,} externally driven, parallel current profile,                                sphdf5.f90, 203)
  HWRITERV_LO( grpInputPhysics,  (Mvol  ), Isurf      ,   Isurf(1:Mvol  )   ,                                                          sphdf5.f90, 204)
  H5DESCR_CDSET( /input/physics/mu, Surface current{,} currents that are not volume currents (pressure driven, shielding currents) ,   sphdf5.f90, 205)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), pl         ,        pl(0:Nvol)   ,                                                          sphdf5.f90, 206)
  H5DESCR_CDSET( /input/physics/pl, pl ?,                                                                                              sphdf5.f90, 207)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), ql         ,        ql(0:Nvol)   ,                                                          sphdf5.f90, 208)
  H5DESCR_CDSET( /input/physics/ql, ql ?,                                                                                              sphdf5.f90, 209)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), pr         ,        pr(0:Nvol)   ,                                                          sphdf5.f90, 210)
  H5DESCR_CDSET( /input/physics/pr, pr ?,                                                                                              sphdf5.f90, 211)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), qr         ,        qr(0:Nvol)   ,                                                          sphdf5.f90, 212)
  H5DESCR_CDSET( /input/physics/qr, qr ?,                                                                                              sphdf5.f90, 213)
  HWRITERV_LO( grpInputPhysics,  (1+Nvol), iota       ,      iota(0:Nvol)   ,                                                          sphdf5.f90, 214)
  H5DESCR_CDSET( /input/physics/iota, rotational transform profile on inside of ideal interfaces,                                      sphdf5.f90, 215)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), lp         ,        lp(0:Nvol)   ,                                                          sphdf5.f90, 216)
  H5DESCR_CDSET( /input/physics/lp, lp ?,                                                                                              sphdf5.f90, 217)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), lq         ,        lq(0:Nvol)   ,                                                          sphdf5.f90, 218)
  H5DESCR_CDSET( /input/physics/lq, lq ?,                                                                                              sphdf5.f90, 219)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), rp         ,        rp(0:Nvol)   ,                                                          sphdf5.f90, 220)
  H5DESCR_CDSET( /input/physics/rp, rp ?,                                                                                              sphdf5.f90, 221)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), rq         ,        rq(0:Nvol)   ,                                                          sphdf5.f90, 222)
  H5DESCR_CDSET( /input/physics/rq, rq ?,                                                                                              sphdf5.f90, 223)
  HWRITERV_LO( grpInputPhysics,  (1+Nvol), oita       ,      oita(0:Nvol)   ,                                                          sphdf5.f90, 224)
  H5DESCR_CDSET( /input/physics/oita, rotational transform profile on outside of ideal interfaces,                                     sphdf5.f90, 225)
  HWRITERV_LO( grpInputPhysics,         1, rtor  , (/ rtor      /),                                                                    sphdf5.f90, 226)
  H5DESCR_CDSET( /input/physics/rpol, for aspect ratio in slab,                                                                        sphdf5.f90, 227)
  HWRITERV_LO( grpInputPhysics,         1, rpol  , (/ rpol      /),                                                                    sphdf5.f90, 228)
  H5DESCR_CDSET( /input/physics/rpol, for aspect ratio in slab,                                                                        sphdf5.f90, 229)

  HWRITERV_LO( grpInputPhysics,  (1+Ntor), Rac        ,       Rac(0:Ntor)   ,                                                          sphdf5.f90, 231)
  H5DESCR_CDSET( /input/physics/Rac,     stellarator symmetric coordinate axis R cosine Fourier coefficients,                          sphdf5.f90, 232)
  HWRITERV_LO( grpInputPhysics,  (1+Ntor), Zas        ,       Zas(0:Ntor)   ,                                                          sphdf5.f90, 233)
  H5DESCR_CDSET( /input/physics/Zas,     stellarator symmetric coordinate axis Z   sine Fourier coefficients,                          sphdf5.f90, 234)
  HWRITERV_LO( grpInputPhysics,  (1+Ntor), Ras        ,       Ras(0:Ntor)   ,                                                          sphdf5.f90, 235)
  H5DESCR_CDSET( /input/physics/Ras, non-stellarator symmetric coordinate axis R   sine Fourier coefficients,                          sphdf5.f90, 236)
  HWRITERV_LO( grpInputPhysics,  (1+Ntor), Zac        ,       Zac(0:Ntor)   ,                                                          sphdf5.f90, 237)
  H5DESCR_CDSET( /input/physics/Zac, non-stellarator symmetric coordinate axis Z cosine Fourier coefficients,                          sphdf5.f90, 238)

  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Rbc, Rbc(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 240)
  H5DESCR_CDSET( /input/physics/Rbc,     stellarator symmetric boundary R cosine Fourier coefficients,                                 sphdf5.f90, 241)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Zbs, Zbs(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 242)
  H5DESCR_CDSET( /input/physics/Zbs,     stellarator symmetric boundary Z   sine Fourier coefficients,                                 sphdf5.f90, 243)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Rbs, Rbs(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 244)
  H5DESCR_CDSET( /input/physics/Rbs, non-stellarator symmetric boundary R   sine Fourier coefficients,                                 sphdf5.f90, 245)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Zbc, Zbc(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 246)
  H5DESCR_CDSET( /input/physics/Zbc, non-stellarator symmetric boundary Z cosine Fourier coefficients,                                 sphdf5.f90, 247)

  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Rwc, Rwc(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 249)
  H5DESCR_CDSET( /input/physics/Rwc,     stellarator symmetric boundary R cosine Fourier coefficients of wall,                         sphdf5.f90, 250)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Zws, Zws(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 251)
  H5DESCR_CDSET( /input/physics/Zws,     stellarator symmetric boundary Z   sine Fourier coefficients of wall,                         sphdf5.f90, 252)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Rws, Rws(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 253)
  H5DESCR_CDSET( /input/physics/Rws, non-stellarator symmetric boundary R   sine Fourier coefficients of wall,                         sphdf5.f90, 254)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Zwc, Zwc(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 255)
  H5DESCR_CDSET( /input/physics/Zwc, non-stellarator symmetric boundary Z cosine Fourier coefficients of wall,                         sphdf5.f90, 256)

  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Vns, Vns(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 258)
  H5DESCR_CDSET( /input/physics/Vns,     stellarator symmetric normal field   sine Fourier coefficients at boundary; vacuum component, sphdf5.f90, 259)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Bns, Bns(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 260)
  H5DESCR_CDSET( /input/physics/Bns,     stellarator symmetric normal field   sine Fourier coefficients at boundary; plasma component, sphdf5.f90, 261)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Vnc, Vnc(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 262)
  H5DESCR_CDSET( /input/physics/Vnc, non-stellarator symmetric normal field cosine Fourier coefficients at boundary; vacuum component, sphdf5.f90, 263)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Bnc, Bnc(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 264)
  H5DESCR_CDSET( /input/physics/Bnc, non-stellarator symmetric normal field cosine Fourier coefficients at boundary; plasma component, sphdf5.f90, 265)

  HWRITERV_LO( grpInputPhysics,           1,   mupftol, (/ mupftol /),                                                                 sphdf5.f90, 267)
  H5DESCR_CDSET( /input/physics/mupftol, mupftol   ,                                                                                   sphdf5.f90, 268)
  HWRITEIV_LO( grpInputPhysics,           1,   mupfits, (/ mupfits /),                                                                 sphdf5.f90, 269)
  H5DESCR_CDSET( /input/physics/mupfits, mupfits   ,                                                                                   sphdf5.f90, 270)

  HCLOSEGRP( grpInputPhysics , sphdf5.f90, 272)
...
! they go into ext.h5/input/numerics
  ...
  HDEFGRP( grpInput, numerics, grpInputNumerics, sphdf5.f90, 279)
  ...
  HCLOSEGRP( grpInputNumerics, sphdf5.f90, 298)
...
subroutine write_convergence_output( nDcalls, ForceErr )
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  H5CALL( sphdf5, h5dget_space_f, (iteration_dset_id, dataspace, hdfier), sphdf5.f90, 527)
  ...
  H5CALL( sphdf5, h5dset_extent_f, (iteration_dset_id, data_dims, hdfier), sphdf5.f90, 535)

  ! get dataspace slab corresponding to region which the iterations dataset was extended by
  H5CALL( sphdf5, h5dget_space_f, (iteration_dset_id, dataspace, hdfier), sphdf5.f90, 538)                                             ! re-select dataspace to update size info in HDF5 lib
  H5CALL( sphdf5, h5sselect_hyperslab_f, (dataspace, H5S_SELECT_SET_F, old_data_dims, (/ INT(1, HSIZE_T) /), hdfier), sphdf5.f90, 539) ! newly appended slab is at old size and 1 long

  ! write next iteration object
  H5CALL( sphdf5, h5dwrite_f, (iteration_dset_id, dt_nDcalls_id, nDcalls, INT((/1/), HSIZE_T), hdfier, &
    & mem_space_id=memspace, file_space_id=dataspace, xfer_prp=plist_id), sphdf5.f90, 543)
  H5CALL( sphdf5, h5dwrite_f, (iteration_dset_id, dt_Energy_id, Energy, INT((/1/), HSIZE_T), hdfier, &
    & mem_space_id=memspace, file_space_id=dataspace, xfer_prp=plist_id), sphdf5.f90, 545)
  H5CALL( sphdf5, h5dwrite_f, (iteration_dset_id, dt_ForceErr_id, ForceErr, INT((/1/), HSIZE_T), hdfier, &
    & mem_space_id=memspace, file_space_id=dataspace, xfer_prp=plist_id), sphdf5.f90, 547)
  H5CALL( sphdf5, h5dwrite_f, (iteration_dset_id, dt_iRbc_id, iRbc, INT((/mn,Mvol+1/), HSIZE_T), hdfier, &
    & mem_space_id=memspace, file_space_id=dataspace, xfer_prp=plist_id), sphdf5.f90, 549)
  H5CALL( sphdf5, h5dwrite_f, (iteration_dset_id, dt_iZbs_id, iZbs, INT((/mn,Mvol+1/), HSIZE_T), hdfier, &
    & mem_space_id=memspace, file_space_id=dataspace, xfer_prp=plist_id), sphdf5.f90, 551)
  H5CALL( sphdf5, h5dwrite_f, (iteration_dset_id, dt_iRbs_id, iRbs, INT((/mn,Mvol+1/), HSIZE_T), hdfier, &
    & mem_space_id=memspace, file_space_id=dataspace, xfer_prp=plist_id), sphdf5.f90, 553)
  H5CALL( sphdf5, h5dwrite_f, (iteration_dset_id, dt_iZbc_id, iZbc, INT((/mn,Mvol+1/), HSIZE_T), hdfier, &
    & mem_space_id=memspace, file_space_id=dataspace, xfer_prp=plist_id), sphdf5.f90, 555)

  ! dataspace to appended object should be closed now
  ! MAYBE we otherwise keep all the iterations in memory?
  H5CALL( sphdf5, h5sclose_f, (dataspace, hdfier), sphdf5.f90, 559)
...
subroutine init_flt_output( numTrajTotal )
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  H5CALL( sphdf5, h5screate_simple_f, (rankP, dims_traj, filespace_t, hdfier), sphdf5.f90, 743 )
  H5CALL( sphdf5, h5screate_simple_f, (rankP, dims_traj, filespace_s, hdfier), sphdf5.f90, 744 )
  H5CALL( sphdf5, h5screate_simple_f, (rankP, dims_traj, filespace_R, hdfier), sphdf5.f90, 745 )
  H5CALL( sphdf5, h5screate_simple_f, (rankP, dims_traj, filespace_Z, hdfier), sphdf5.f90, 746 )
  H5CALL( sphdf5, h5screate_simple_f, (1, int((/ numTrajTotal /),HSIZE_T), filespace_success, hdfier), sphdf5.f90, 747 )

  ! Create the dataset with default properties.
  H5CALL( sphdf5, h5dcreate_f, (grpPoincare, "t", H5T_NATIVE_DOUBLE, filespace_t, dset_id_t, hdfier), sphdf5.f90, 750 )
  H5CALL( sphdf5, h5dcreate_f, (grpPoincare, "s", H5T_NATIVE_DOUBLE, filespace_s, dset_id_s, hdfier), sphdf5.f90, 751 )
  H5CALL( sphdf5, h5dcreate_f, (grpPoincare, "R", H5T_NATIVE_DOUBLE, filespace_R, dset_id_R, hdfier), sphdf5.f90, 752 )
  H5CALL( sphdf5, h5dcreate_f, (grpPoincare, "Z", H5T_NATIVE_DOUBLE, filespace_Z, dset_id_Z, hdfier), sphdf5.f90, 753 )
  H5CALL( sphdf5, h5dcreate_f, (grpPoincare, "success", H5T_NATIVE_INTEGER, filespace_success, dset_id_success, hdfier), sphdf5.f90, 754 )

  ! filespaces can be closed as soon as datasets are created
  H5CALL( sphdf5, h5sclose_f, (filespace_t, hdfier), sphdf5.f90, 757 )
  H5CALL( sphdf5, h5sclose_f, (filespace_s, hdfier), sphdf5.f90, 758 )
  H5CALL( sphdf5, h5sclose_f, (filespace_R, hdfier), sphdf5.f90, 759 )
  H5CALL( sphdf5, h5sclose_f, (filespace_Z, hdfier), sphdf5.f90, 760 )
  H5CALL( sphdf5, h5sclose_f, (filespace_success, hdfier), sphdf5.f90, 761 )

  ! Select hyperslab in the file.
  H5CALL( sphdf5, h5dget_space_f, (dset_id_t, filespace_t, hdfier), sphdf5.f90, 764 )
  H5CALL( sphdf5, h5dget_space_f, (dset_id_s, filespace_s, hdfier), sphdf5.f90, 765 )
  H5CALL( sphdf5, h5dget_space_f, (dset_id_R, filespace_R, hdfier), sphdf5.f90, 766 )
  H5CALL( sphdf5, h5dget_space_f, (dset_id_Z, filespace_Z, hdfier), sphdf5.f90, 767 )
  H5CALL( sphdf5, h5dget_space_f, (dset_id_success, filespace_success, hdfier), sphdf5.f90, 768 )

  ! Each process defines dataset in memory and writes it to the hyperslab in the file.
  H5CALL( sphdf5, h5screate_simple_f, (rankP, length, memspace_t, hdfier), sphdf5.f90, 771 )
  H5CALL( sphdf5, h5screate_simple_f, (rankP, length, memspace_s, hdfier), sphdf5.f90, 772 )
  H5CALL( sphdf5, h5screate_simple_f, (rankP, length, memspace_R, hdfier), sphdf5.f90, 773 )
  H5CALL( sphdf5, h5screate_simple_f, (rankP, length, memspace_Z, hdfier), sphdf5.f90, 774 )
  H5CALL( sphdf5, h5screate_simple_f, (1, int((/ 1 /),HSIZE_T), memspace_success, hdfier), sphdf5.f90, 775 )

  ! create rotational transform group in HDF5 file
  HDEFGRP( file_id, transform, grpTransform )

  ! Create the data space for the  dataset.
  H5CALL( sphdf5, h5screate_simple_f, (rankT, int((/           2,Mvol/),HSIZE_T), filespace_diotadxup, hdfier), sphdf5.f90, 781 )
  H5CALL( sphdf5, h5screate_simple_f, (rankT, int((/numTrajTotal,   2/),HSIZE_T), filespace_fiota    , hdfier), sphdf5.f90, 782 )

  ! Create the dataset with default properties.
  H5CALL( sphdf5, h5dcreate_f, (grpTransform, "diotadxup", H5T_NATIVE_DOUBLE, filespace_diotadxup, dset_id_diotadxup, hdfier), sphdf5.f90, 785 )
  H5CALL( sphdf5, h5dcreate_f, (grpTransform,     "fiota", H5T_NATIVE_DOUBLE, filespace_fiota    , dset_id_fiota    , hdfier), sphdf5.f90, 786 )

  ! filespaces can be closed as soon as datasets are created
  H5CALL( sphdf5, h5sclose_f, (filespace_diotadxup, hdfier), sphdf5.f90, 789 )
  H5CALL( sphdf5, h5sclose_f, (filespace_fiota    , hdfier), sphdf5.f90, 790 )

  ! Select hyperslab in the file.
  H5CALL( sphdf5, h5dget_space_f, (dset_id_diotadxup, filespace_diotadxup, hdfier), sphdf5.f90, 793 )
  H5CALL( sphdf5, h5dget_space_f, (dset_id_fiota    , filespace_fiota    , hdfier), sphdf5.f90, 794 )

  ! Each process defines dataset in memory and writes it to the hyperslab in the file.
  H5CALL( sphdf5, h5screate_simple_f, (rankT, int((/2,1/),HSIZE_T), memspace_diotadxup, hdfier), sphdf5.f90, 797 )
...
subroutine write_poincare( offset, data, success )
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  H5CALL( sphdf5, h5sselect_hyperslab_f, (filespace_t, H5S_SELECT_SET_F, int((/0,0,offset/),HSSIZE_T), length, hdfier), sphdf5.f90, 830 )
  H5CALL( sphdf5, h5dwrite_f, (dset_id_t, H5T_NATIVE_DOUBLE, data(1,1:Nz,1:nPpts), dims_singleTraj, hdfier, &
  &               file_space_id=filespace_t, mem_space_id=memspace_t ), sphdf5.f90, 832 )

  H5CALL( sphdf5, h5sselect_hyperslab_f, (filespace_s, H5S_SELECT_SET_F, int((/0,0,offset/),HSSIZE_T), length, hdfier), sphdf5.f90, 834 )
  H5CALL( sphdf5, h5dwrite_f, (dset_id_s, H5T_NATIVE_DOUBLE, data(2,1:Nz,1:nPpts), dims_singleTraj, hdfier, &
  &               file_space_id=filespace_s, mem_space_id=memspace_s ), sphdf5.f90, 836 )

  H5CALL( sphdf5, h5sselect_hyperslab_f, (filespace_R, H5S_SELECT_SET_F, int((/0,0,offset/),HSSIZE_T), length, hdfier), sphdf5.f90, 838 )
  H5CALL( sphdf5, h5dwrite_f, (dset_id_R, H5T_NATIVE_DOUBLE, data(3,1:Nz,1:nPpts), dims_singleTraj, hdfier, &
  &               file_space_id=filespace_R, mem_space_id=memspace_R ), sphdf5.f90, 840 )

  H5CALL( sphdf5, h5sselect_hyperslab_f, (filespace_Z, H5S_SELECT_SET_F, int((/0,0,offset/),HSSIZE_T), length, hdfier), sphdf5.f90, 842 )
  H5CALL( sphdf5, h5dwrite_f, (dset_id_Z, H5T_NATIVE_DOUBLE, data(4,1:Nz,1:nPpts), dims_singleTraj, hdfier, &
  &               file_space_id=filespace_Z, mem_space_id=memspace_Z ), sphdf5.f90, 844 )

  H5CALL( sphdf5, h5sselect_hyperslab_f, (filespace_success, H5S_SELECT_SET_F, int((/offset/),HSSIZE_T), int((/1/), HSIZE_T), hdfier), sphdf5.f90, 846 )
  H5CALL( sphdf5, h5dwrite_f, (dset_id_success, H5T_NATIVE_INTEGER, success, int((/1/), HSIZE_T), hdfier, &
  &               file_space_id=filespace_success, mem_space_id=memspace_success ), sphdf5.f90, 848 )
...
subroutine write_transform( offset, length, lvol, diotadxup, fiota )
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  H5CALL( sphdf5, h5sselect_hyperslab_f, (filespace_diotadxup, H5S_SELECT_SET_F, int((/0,lvol-1/),HSSIZE_T), int((/2,1/),HSSIZE_T), hdfier), sphdf5.f90, 872 )
  H5CALL( sphdf5, h5dwrite_f, (dset_id_diotadxup, H5T_NATIVE_DOUBLE, diotadxup, int((/2,1/),HSSIZE_T), hdfier, &
  &               file_space_id=filespace_diotadxup, mem_space_id=memspace_diotadxup ), sphdf5.f90, 874 )

  ! length of fiota piece to write here may change, so open and close memspace each time a new hyperslab is written
  H5CALL( sphdf5, h5screate_simple_f, (rankT, int((/length,2/),HSIZE_T), memspace_fiota    , hdfier), sphdf5.f90, 877 )

  H5CALL( sphdf5, h5sselect_hyperslab_f, (filespace_fiota, H5S_SELECT_SET_F, int((/offset,0/),HSSIZE_T), int((/length,2/),HSSIZE_T), hdfier), sphdf5.f90, 879 )
  H5CALL( sphdf5, h5dwrite_f, (dset_id_fiota, H5T_NATIVE_DOUBLE, fiota(1:length,1:2), int((/length,2/),HSSIZE_T), hdfier, &
  &               file_space_id=filespace_fiota, mem_space_id=memspace_fiota ), sphdf5.f90, 881 )

  H5CALL( sphdf5, h5sclose_f, (memspace_fiota, hdfier), sphdf5.f90, 883 )
...
subroutine finalize_flt_output
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  ! close filespaces
  H5CALL( sphdf5, h5sclose_f, (filespace_t,         hdfier), sphdf5.f90, 904 )
  H5CALL( sphdf5, h5sclose_f, (filespace_s,         hdfier), sphdf5.f90, 905 )
  H5CALL( sphdf5, h5sclose_f, (filespace_R,         hdfier), sphdf5.f90, 906 )
  H5CALL( sphdf5, h5sclose_f, (filespace_Z,         hdfier), sphdf5.f90, 907 )
  H5CALL( sphdf5, h5sclose_f, (filespace_success,   hdfier), sphdf5.f90, 908 )
  H5CALL( sphdf5, h5sclose_f, (filespace_diotadxup, hdfier), sphdf5.f90, 909 )
  H5CALL( sphdf5, h5sclose_f, (filespace_fiota,     hdfier), sphdf5.f90, 910 )

  ! close dataspaces
  H5CALL( sphdf5, h5sclose_f, (memspace_t,          hdfier), sphdf5.f90, 913 )
  H5CALL( sphdf5, h5sclose_f, (memspace_s,          hdfier), sphdf5.f90, 914 )
  H5CALL( sphdf5, h5sclose_f, (memspace_R,          hdfier), sphdf5.f90, 915 )
  H5CALL( sphdf5, h5sclose_f, (memspace_Z,          hdfier), sphdf5.f90, 916 )
  H5CALL( sphdf5, h5sclose_f, (memspace_success,    hdfier), sphdf5.f90, 917 )
  H5CALL( sphdf5, h5sclose_f, (memspace_diotadxup,  hdfier), sphdf5.f90, 918 )
  ! memspace_fiota is re-opened/closed in each iteration (see write_transform)

  ! close datasets
  H5CALL( sphdf5, h5dclose_f, (dset_id_t,           hdfier), sphdf5.f90, 922 )
  H5CALL( sphdf5, h5dclose_f, (dset_id_s,           hdfier), sphdf5.f90, 923 )
  H5CALL( sphdf5, h5dclose_f, (dset_id_R,           hdfier), sphdf5.f90, 924 )
  H5CALL( sphdf5, h5dclose_f, (dset_id_Z,           hdfier), sphdf5.f90, 925 )
  H5CALL( sphdf5, h5dclose_f, (dset_id_success,     hdfier), sphdf5.f90, 926 )
  H5CALL( sphdf5, h5dclose_f, (dset_id_diotadxup,   hdfier), sphdf5.f90, 927 )
  H5CALL( sphdf5, h5dclose_f, (dset_id_fiota,       hdfier), sphdf5.f90, 928 )
...
!> </ul>
  ...
  !! Write the force and force gradient to the output file for testing of the Beltrami solver
  !! The force expressed as the standard truncated Fourier spectrum
  if( Lcheck.eq.7 ) then
...
! The goal should be to close all objects specifically!
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  H5CALL( sphdf5, h5tclose_f, (dt_nDcalls_id, hdfier)    , sphdf5.f90, 1158)
  H5CALL( sphdf5, h5tclose_f, (dt_Energy_id, hdfier)     , sphdf5.f90, 1159)
  H5CALL( sphdf5, h5tclose_f, (dt_ForceErr_id, hdfier)   , sphdf5.f90, 1160)
  H5CALL( sphdf5, h5tclose_f, (dt_iRbc_id, hdfier)       , sphdf5.f90, 1161)
  H5CALL( sphdf5, h5tclose_f, (dt_iZbs_id, hdfier)       , sphdf5.f90, 1162)
  H5CALL( sphdf5, h5tclose_f, (dt_iRbs_id, hdfier)       , sphdf5.f90, 1163)
  H5CALL( sphdf5, h5tclose_f, (dt_iZbc_id, hdfier)       , sphdf5.f90, 1164)
  H5CALL( sphdf5, h5dclose_f, (iteration_dset_id, hdfier), sphdf5.f90, 1165) ! End access to the dataset and release resources used by it.
  H5CALL( sphdf5, h5pclose_f, (plist_id, hdfier)         , sphdf5.f90, 1166) ! close plist used for 'preserve' flag (does not show up in obj_count below)
  ...
  H5CALL( sphdf5, h5fget_obj_count_f, (file_id, ior(H5F_OBJ_GROUP_F, ior(H5F_OBJ_DATASET_F, H5F_OBJ_DATATYPE_F)), obj_count, hdfier), sphdf5.f90, 1169 )
  ...
  if (obj_count.gt.0) then
    ...
    ! groups
    H5CALL( sphdf5, h5fget_obj_ids_f, (file_id, H5F_OBJ_GROUP_F, obj_count, obj_ids, hdfier, num_objs), sphdf5.f90, 1176) ! get for open objects
    if (num_objs.gt.0) then
      write(*,'("There are still ",i3," HDF5 groups open:")') num_objs
      do iObj=1,num_objs
        openLength=0
        H5CALL( sphdf5, h5iget_name_f, (obj_ids(iObj), dummyName, dummySize, openLength, hdfier), sphdf5.f90, 1181)
        allocate(character(len=openLength+1) :: openName)
        H5CALL( sphdf5, h5iget_name_f, (obj_ids(iObj), openName, openLength, openLength, hdfier), sphdf5.f90, 1183)
        write(*,*) openName
        deallocate(openName)

        H5CALL( sphdf5, h5gclose_f, (obj_ids(iObj), hdfier), sphdf5.f90, 1187)
      enddo
    endif

    ! datasets
    H5CALL( sphdf5, h5fget_obj_ids_f, (file_id, H5F_OBJ_DATASET_F, obj_count, obj_ids, hdfier, num_objs), sphdf5.f90, 1192) ! get for open objects
    if (num_objs.gt.0) then
      write(*,'("There are still ",i3," HDF5 datasets open:")') num_objs
      do iObj=1,num_objs
        openLength=0
        H5CALL( sphdf5, h5iget_name_f, (obj_ids(iObj), dummyName, dummySize, openLength, hdfier), sphdf5.f90, 1197)
        allocate(character(len=openLength+1) :: openName)
        H5CALL( sphdf5, h5iget_name_f, (obj_ids(iObj), openName, openLength, openLength, hdfier), sphdf5.f90, 1199)
        write(*,*) openName(1:openLength)
        deallocate(openName)

        H5CALL( sphdf5, h5dclose_f, (obj_ids(iObj), hdfier), sphdf5.f90, 1203)
      enddo
    endif

    ! datatypes
    H5CALL( sphdf5, h5fget_obj_ids_f, (file_id, H5F_OBJ_DATATYPE_F, obj_count, obj_ids, hdfier, num_objs), sphdf5.f90, 1208) ! get for open objects
    if (num_objs.gt.0) then
      write(*,'("There are still ",i3," HDF5 datatypes open:")') num_objs
      do iObj=1,num_objs
        H5CALL( sphdf5, h5tget_class_f, (obj_ids(iObj), typeClass, hdfier), 1212, sphdf5.f90) ! determine class of open datatype
        ...
        H5CALL( sphdf5, h5tclose_f, (obj_ids(iObj), hdfier), sphdf5.f90, 1227)
      enddo
    endif
  ...
  H5CALL( sphdf5, h5fclose_f, ( file_id, hdfier ), sphdf5.f90, 1234 ) ! terminate access on output file;
  H5CALL( sphdf5, h5close_f,  ( hdfier ),          sphdf5.f90, 1235 ) ! close Fortran interface to the HDF5 library;
