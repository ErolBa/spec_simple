...
subroutine init_outfile
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  H5CALL( sphdf5, h5open_f, (hdfier), sphdf5.f90, 93)

  H5CALL( sphdf5, h5eset_auto_f, (internalHdf5Msg, hdfier), sphdf5.f90, 95)

  H5CALL( sphdf5, h5fcreate_f, (trim(ext)//".sp.h5", H5F_ACC_TRUNC_F, file_id, hdfier ), sphdf5.f90, 97 )

  HWRITERV_LO( file_id, 1, version, (/ version /), sphdf5.f90, 99)
  H5DESCR_CDSET( /version, version of SPEC,        sphdf5.f90, 100)
...
subroutine mirror_input_to_outfile
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  HDEFGRP( file_id, input, grpInput,                        sphdf5.f90, 120 )
  H5DESCR( grpInput, /input, group for mirrored input data, sphdf5.f90, 121 )



  HDEFGRP( grpInput, physics, grpInputPhysics,                                                                                         sphdf5.f90, 125)
  H5DESCR( grpInputPhysics, /input/physics, physics inputs,                                                                            sphdf5.f90, 126)

  HWRITEIV_LO( grpInputPhysics,         1, Igeometry  , (/ Igeometry      /),                                                          sphdf5.f90, 128)
  H5DESCR_CDSET( /input/physics/Igeometry, geometry identifier,                                                                        sphdf5.f90, 129)
  HWRITEIV_LO( grpInputPhysics,         1, Istellsym  , (/ Istellsym      /),                                                          sphdf5.f90, 130)
  H5DESCR_CDSET( /input/physics/Istellsym, stellarator symmetry flag,                                                                  sphdf5.f90, 131)
  HWRITEIV_LO( grpInputPhysics,         1, Lfreebound , (/ Lfreebound     /),                                                          sphdf5.f90, 132)
  H5DESCR_CDSET( /input/physics/Lfreebound, free boundary flag,                                                                        sphdf5.f90, 133)
  HWRITERV_LO( grpInputPhysics,         1, phiedge    , (/ phiedge        /),                                                          sphdf5.f90, 134)
  H5DESCR_CDSET( /input/physics/phiedge, total enclosed toroidal magnetic flux,                                                        sphdf5.f90, 135)
  HWRITERV_LO( grpInputPhysics,         1, curtor     , (/ curtor         /),                                                          sphdf5.f90, 136)
  H5DESCR_CDSET( /input/physics/curtor, total enclosed toroidal current,                                                               sphdf5.f90, 137)
  HWRITERV_LO( grpInputPhysics,         1, curpol     , (/ curpol         /),                                                          sphdf5.f90, 138)
  H5DESCR_CDSET( /input/physics/curpol, total enclosed poloidal current,                                                               sphdf5.f90, 139)
  HWRITERV_LO( grpInputPhysics,         1, gamma      , (/ gamma          /),                                                          sphdf5.f90, 140)
  H5DESCR_CDSET( /input/physics/gamma, adiabatic index,                                                                                sphdf5.f90, 141)
  HWRITEIV_LO( grpInputPhysics,         1, Nfp        , (/ Nfp            /),                                                          sphdf5.f90, 142)
  H5DESCR_CDSET( /input/physics/Nfp, number of stellarator field periods,                                                              sphdf5.f90, 143)
  HWRITEIV_LO( grpInputPhysics,         1, Nvol       , (/ Nvol           /),                                                          sphdf5.f90, 144)
  H5DESCR_CDSET( /input/physics/Nvol, number of volumes,                                                                               sphdf5.f90, 145)
  HWRITEIV_LO( grpInputPhysics,         1, Mpol       , (/ Mpol           /),                                                          sphdf5.f90, 146)
  H5DESCR_CDSET( /input/physics/Mpol, maximum poloidal mode number,                                                                    sphdf5.f90, 147)
  HWRITEIV_LO( grpInputPhysics,         1, Ntor       , (/ Ntor           /),                                                          sphdf5.f90, 148)
  H5DESCR_CDSET( /input/physics/Ntor, maximum toroidal mode number,                                                                    sphdf5.f90, 149)
  HWRITEIV_LO( grpInputPhysics,      Mvol, Lrad       ,      Lrad(1:Mvol)   ,                                                          sphdf5.f90, 150)
  H5DESCR_CDSET( /input/physics/Lrad, degree of radial Chebychev polynomials,                                                          sphdf5.f90, 151)
  HWRITEIV_LO( grpInputPhysics,         1, Lconstraint, (/ Lconstraint    /),                                                          sphdf5.f90, 152)
  H5DESCR_CDSET( /input/physics/Lconstraint, type of constraint to enforce,                                                            sphdf5.f90, 153)
  HWRITEIV_LO( grpInputPhysics,         1, Lreflect,    (/ Lreflect       /),                                                          sphdf5.f90, 154)
  H5DESCR_CDSET( /input/physics/Lreflect, whether to reflect the perturbation on both boundaries for slab geometry                     sphdf5.f90, 155)
  HWRITERV_LO( grpInputPhysics,      Mvol, tflux      ,     tflux(1:Mvol)   ,                                                          sphdf5.f90, 156)
  H5DESCR_CDSET( /input/physics/tflux, toroidal magnetic flux in volumes,                                                              sphdf5.f90, 157)
  HWRITERV_LO( grpInputPhysics,      Mvol, pflux      ,     pflux(1:Mvol)   ,                                                          sphdf5.f90, 158)
  H5DESCR_CDSET( /input/physics/pflux, poloidal magnetic flux in volumes,                                                              sphdf5.f90, 159)
  HWRITERV_LO( grpInputPhysics,      Nvol, helicity   ,  helicity(1:Nvol)   ,                                                          sphdf5.f90, 160)
  H5DESCR_CDSET( /input/physics/helicity, helicity profile,                                                                            sphdf5.f90, 161)
  HWRITERV_LO( grpInputPhysics,         1, pscale     , (/ pscale         /),                                                          sphdf5.f90, 162)
  H5DESCR_CDSET( /input/physics/pscale, scaling factor for pressure,                                                                   sphdf5.f90, 163)
  HWRITERV_LO( grpInputPhysics,      Nvol, pressure   ,  pressure(1:Nvol)   ,                                                          sphdf5.f90, 164)
  H5DESCR_CDSET( /input/physics/pressure, pressure profile,                                                                            sphdf5.f90, 165)
  HWRITEIV_LO( grpInputPhysics,         1, Ladiabatic , (/ Ladiabatic     /),                                                          sphdf5.f90, 166)
  H5DESCR_CDSET( /input/physics/Ladiabatic, adiabatic flag,                                                                            sphdf5.f90, 167)
  HWRITERV_LO( grpInputPhysics,      Mvol, adiabatic  , adiabatic(1:Nvol)   ,                                                          sphdf5.f90, 168)
  H5DESCR_CDSET( /input/physics/adiabatic, adiabatic profile (?),                                                                      sphdf5.f90, 169)
  HWRITERV_LO( grpInputPhysics,  (1+Nvol), mu         ,        mu(1:Mvol)   ,                                                          sphdf5.f90, 170)
  H5DESCR_CDSET( /input/physics/mu, Beltrami parameter{,} parallel current profile,                                                    sphdf5.f90, 171)
  HWRITERV_LO( grpInputPhysics,  (1+Nvol), Ivolume    ,   Ivolume(1:Mvol)   ,                                                          sphdf5.f90, 172)
  H5DESCR_CDSET( /input/physics/Ivolume, Volume current{,} externally driven, parallel current profile,                                sphdf5.f90, 173)
  HWRITERV_LO( grpInputPhysics,  (Mvol  ), Isurf      ,   Isurf(1:Mvol  )   ,                                                          sphdf5.f90, 174)
  H5DESCR_CDSET( /input/physics/mu, Surface current{,} currents that are not volume currents (pressure driven, shielding currents) ,   sphdf5.f90, 175)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), pl         ,        pl(0:Nvol)   ,                                                          sphdf5.f90, 176)
  H5DESCR_CDSET( /input/physics/pl, pl ?,                                                                                              sphdf5.f90, 177)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), ql         ,        ql(0:Nvol)   ,                                                          sphdf5.f90, 178)
  H5DESCR_CDSET( /input/physics/ql, ql ?,                                                                                              sphdf5.f90, 179)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), pr         ,        pr(0:Nvol)   ,                                                          sphdf5.f90, 180)
  H5DESCR_CDSET( /input/physics/pr, pr ?,                                                                                              sphdf5.f90, 181)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), qr         ,        qr(0:Nvol)   ,                                                          sphdf5.f90, 182)
  H5DESCR_CDSET( /input/physics/qr, qr ?,                                                                                              sphdf5.f90, 183)
  HWRITERV_LO( grpInputPhysics,  (1+Nvol), iota       ,      iota(0:Nvol)   ,                                                          sphdf5.f90, 184)
  H5DESCR_CDSET( /input/physics/iota, rotational transform profile on inside of ideal interfaces,                                      sphdf5.f90, 185)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), lp         ,        lp(0:Nvol)   ,                                                          sphdf5.f90, 186)
  H5DESCR_CDSET( /input/physics/lp, lp ?,                                                                                              sphdf5.f90, 187)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), lq         ,        lq(0:Nvol)   ,                                                          sphdf5.f90, 188)
  H5DESCR_CDSET( /input/physics/lq, lq ?,                                                                                              sphdf5.f90, 189)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), rp         ,        rp(0:Nvol)   ,                                                          sphdf5.f90, 190)
  H5DESCR_CDSET( /input/physics/rp, rp ?,                                                                                              sphdf5.f90, 191)
  HWRITEIV_LO( grpInputPhysics,  (1+Mvol), rq         ,        rq(0:Nvol)   ,                                                          sphdf5.f90, 192)
  H5DESCR_CDSET( /input/physics/rq, rq ?,                                                                                              sphdf5.f90, 193)
  HWRITERV_LO( grpInputPhysics,  (1+Nvol), oita       ,      oita(0:Nvol)   ,                                                          sphdf5.f90, 194)
  H5DESCR_CDSET( /input/physics/oita, rotational transform profile on outside of ideal interfaces,                                     sphdf5.f90, 195)
  HWRITERV_LO( grpInputPhysics,         1, rtor  , (/ rtor      /),                                                                    sphdf5.f90, 196)
  H5DESCR_CDSET( /input/physics/rpol, for aspect ratio in slab,                                                                        sphdf5.f90, 197)
  HWRITERV_LO( grpInputPhysics,         1, rpol  , (/ rpol      /),                                                                    sphdf5.f90, 198)
  H5DESCR_CDSET( /input/physics/rpol, for aspect ratio in slab,                                                                        sphdf5.f90, 199)

  HWRITERV_LO( grpInputPhysics,  (1+Ntor), Rac        ,       Rac(0:Ntor)   ,                                                          sphdf5.f90, 201)
  H5DESCR_CDSET( /input/physics/Rac,     stellarator symmetric coordinate axis R cosine Fourier coefficients,                          sphdf5.f90, 202)
  HWRITERV_LO( grpInputPhysics,  (1+Ntor), Zas        ,       Zas(0:Ntor)   ,                                                          sphdf5.f90, 203)
  H5DESCR_CDSET( /input/physics/Zas,     stellarator symmetric coordinate axis Z   sine Fourier coefficients,                          sphdf5.f90, 204)
  HWRITERV_LO( grpInputPhysics,  (1+Ntor), Ras        ,       Ras(0:Ntor)   ,                                                          sphdf5.f90, 205)
  H5DESCR_CDSET( /input/physics/Ras, non-stellarator symmetric coordinate axis R   sine Fourier coefficients,                          sphdf5.f90, 206)
  HWRITERV_LO( grpInputPhysics,  (1+Ntor), Zac        ,       Zac(0:Ntor)   ,                                                          sphdf5.f90, 207)
  H5DESCR_CDSET( /input/physics/Zac, non-stellarator symmetric coordinate axis Z cosine Fourier coefficients,                          sphdf5.f90, 208)

  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Rbc, Rbc(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 210)
  H5DESCR_CDSET( /input/physics/Rbc,     stellarator symmetric boundary R cosine Fourier coefficients,                                 sphdf5.f90, 211)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Zbs, Zbs(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 212)
  H5DESCR_CDSET( /input/physics/Zbs,     stellarator symmetric boundary Z   sine Fourier coefficients,                                 sphdf5.f90, 213)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Rbs, Rbs(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 214)
  H5DESCR_CDSET( /input/physics/Rbs, non-stellarator symmetric boundary R   sine Fourier coefficients,                                 sphdf5.f90, 215)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Zbc, Zbc(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 216)
  H5DESCR_CDSET( /input/physics/Zbc, non-stellarator symmetric boundary Z cosine Fourier coefficients,                                 sphdf5.f90, 217)

  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Rwc, Rwc(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 219)
  H5DESCR_CDSET( /input/physics/Rwc,     stellarator symmetric boundary R cosine Fourier coefficients of wall,                         sphdf5.f90, 220)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Zws, Zws(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 221)
  H5DESCR_CDSET( /input/physics/Zws,     stellarator symmetric boundary Z   sine Fourier coefficients of wall,                         sphdf5.f90, 222)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Rws, Rws(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 223)
  H5DESCR_CDSET( /input/physics/Rws, non-stellarator symmetric boundary R   sine Fourier coefficients of wall,                         sphdf5.f90, 224)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Zwc, Zwc(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 225)
  H5DESCR_CDSET( /input/physics/Zwc, non-stellarator symmetric boundary Z cosine Fourier coefficients of wall,                         sphdf5.f90, 226)

  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Vns, Vns(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 228)
  H5DESCR_CDSET( /input/physics/Vns,     stellarator symmetric normal field   sine Fourier coefficients at boundary; vacuum component, sphdf5.f90, 229)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Bns, Bns(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 230)
  H5DESCR_CDSET( /input/physics/Bns,     stellarator symmetric normal field   sine Fourier coefficients at boundary; plasma component, sphdf5.f90, 231)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Vnc, Vnc(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 232)
  H5DESCR_CDSET( /input/physics/Vnc, non-stellarator symmetric normal field cosine Fourier coefficients at boundary; vacuum component, sphdf5.f90, 233)
  HWRITERA_LO( grpInputPhysics, (2*Ntor+1), (2*Mpol+1),  Bnc, Bnc(-Ntor:Ntor,-Mpol:Mpol),                                              sphdf5.f90, 234)
  H5DESCR_CDSET( /input/physics/Bnc, non-stellarator symmetric normal field cosine Fourier coefficients at boundary; plasma component, sphdf5.f90, 235)

  HWRITERV_LO( grpInputPhysics,           1,   mupftol, (/ mupftol /),                                                                 sphdf5.f90, 237)
  H5DESCR_CDSET( /input/physics/mupftol, mupftol   ,                                                                                   sphdf5.f90, 238)
  HWRITEIV_LO( grpInputPhysics,           1,   mupfits, (/ mupfits /),                                                                 sphdf5.f90, 239)
  H5DESCR_CDSET( /input/physics/mupfits, mupfits   ,                                                                                   sphdf5.f90, 240)

  HCLOSEGRP( grpInputPhysics , sphdf5.f90, 242)




  HDEFGRP( grpInput, numerics, grpInputNumerics, sphdf5.f90, 247)
  ...
  HCLOSEGRP( grpInputNumerics, sphdf5.f90, 266)
...
subroutine write_convergence_output( nDcalls, ForceErr )
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  H5CALL( sphdf5, h5dget_space_f, (iteration_dset_id, dataspace, hdfier), sphdf5.f90, 456)
  ...
  H5CALL( sphdf5, h5dset_extent_f, (iteration_dset_id, data_dims, hdfier), sphdf5.f90, 462)

  H5CALL( sphdf5, h5dget_space_f, (iteration_dset_id, dataspace, hdfier), sphdf5.f90, 464)                                             ! re-select dataspace to update size info in HDF5 lib
  H5CALL( sphdf5, h5sselect_hyperslab_f, (dataspace, H5S_SELECT_SET_F, old_data_dims, (/ INT(1, HSIZE_T) /), hdfier), sphdf5.f90, 465) ! newly appended slab is at old size and 1 long

  H5CALL( sphdf5, h5dwrite_f, (iteration_dset_id, dt_nDcalls_id, nDcalls, INT((/1/), HSIZE_T), hdfier, &
    & mem_space_id=memspace, file_space_id=dataspace, xfer_prp=plist_id), sphdf5.f90, 468)
  H5CALL( sphdf5, h5dwrite_f, (iteration_dset_id, dt_Energy_id, Energy, INT((/1/), HSIZE_T), hdfier, &
    & mem_space_id=memspace, file_space_id=dataspace, xfer_prp=plist_id), sphdf5.f90, 470)
  H5CALL( sphdf5, h5dwrite_f, (iteration_dset_id, dt_ForceErr_id, ForceErr, INT((/1/), HSIZE_T), hdfier, &
    & mem_space_id=memspace, file_space_id=dataspace, xfer_prp=plist_id), sphdf5.f90, 472)
  H5CALL( sphdf5, h5dwrite_f, (iteration_dset_id, dt_iRbc_id, iRbc, INT((/mn,Mvol+1/), HSIZE_T), hdfier, &
    & mem_space_id=memspace, file_space_id=dataspace, xfer_prp=plist_id), sphdf5.f90, 474)
  H5CALL( sphdf5, h5dwrite_f, (iteration_dset_id, dt_iZbs_id, iZbs, INT((/mn,Mvol+1/), HSIZE_T), hdfier, &
    & mem_space_id=memspace, file_space_id=dataspace, xfer_prp=plist_id), sphdf5.f90, 476)
  H5CALL( sphdf5, h5dwrite_f, (iteration_dset_id, dt_iRbs_id, iRbs, INT((/mn,Mvol+1/), HSIZE_T), hdfier, &
    & mem_space_id=memspace, file_space_id=dataspace, xfer_prp=plist_id), sphdf5.f90, 478)
  H5CALL( sphdf5, h5dwrite_f, (iteration_dset_id, dt_iZbc_id, iZbc, INT((/mn,Mvol+1/), HSIZE_T), hdfier, &
    & mem_space_id=memspace, file_space_id=dataspace, xfer_prp=plist_id), sphdf5.f90, 480)

  H5CALL( sphdf5, h5sclose_f, (dataspace, hdfier), sphdf5.f90, 482)
...
subroutine init_flt_output( numTrajTotal )
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  H5CALL( sphdf5, h5screate_simple_f, (rankP, dims_traj, filespace_t, hdfier), sphdf5.f90, 645 )
  H5CALL( sphdf5, h5screate_simple_f, (rankP, dims_traj, filespace_s, hdfier), sphdf5.f90, 646 )
  H5CALL( sphdf5, h5screate_simple_f, (rankP, dims_traj, filespace_R, hdfier), sphdf5.f90, 647 )
  H5CALL( sphdf5, h5screate_simple_f, (rankP, dims_traj, filespace_Z, hdfier), sphdf5.f90, 648 )
  H5CALL( sphdf5, h5screate_simple_f, (1, int((/ numTrajTotal /),HSIZE_T), filespace_success, hdfier), sphdf5.f90, 649 )

  H5CALL( sphdf5, h5dcreate_f, (grpPoincare, "t", H5T_NATIVE_DOUBLE, filespace_t, dset_id_t, hdfier), sphdf5.f90, 651 )
  H5CALL( sphdf5, h5dcreate_f, (grpPoincare, "s", H5T_NATIVE_DOUBLE, filespace_s, dset_id_s, hdfier), sphdf5.f90, 652 )
  H5CALL( sphdf5, h5dcreate_f, (grpPoincare, "R", H5T_NATIVE_DOUBLE, filespace_R, dset_id_R, hdfier), sphdf5.f90, 653 )
  H5CALL( sphdf5, h5dcreate_f, (grpPoincare, "Z", H5T_NATIVE_DOUBLE, filespace_Z, dset_id_Z, hdfier), sphdf5.f90, 654 )
  H5CALL( sphdf5, h5dcreate_f, (grpPoincare, "success", H5T_NATIVE_INTEGER, filespace_success, dset_id_success, hdfier), sphdf5.f90, 655 )

  H5CALL( sphdf5, h5sclose_f, (filespace_t, hdfier), sphdf5.f90, 657 )
  H5CALL( sphdf5, h5sclose_f, (filespace_s, hdfier), sphdf5.f90, 658 )
  H5CALL( sphdf5, h5sclose_f, (filespace_R, hdfier), sphdf5.f90, 659 )
  H5CALL( sphdf5, h5sclose_f, (filespace_Z, hdfier), sphdf5.f90, 660 )
  H5CALL( sphdf5, h5sclose_f, (filespace_success, hdfier), sphdf5.f90, 661 )

  H5CALL( sphdf5, h5dget_space_f, (dset_id_t, filespace_t, hdfier), sphdf5.f90, 663 )
  H5CALL( sphdf5, h5dget_space_f, (dset_id_s, filespace_s, hdfier), sphdf5.f90, 664 )
  H5CALL( sphdf5, h5dget_space_f, (dset_id_R, filespace_R, hdfier), sphdf5.f90, 665 )
  H5CALL( sphdf5, h5dget_space_f, (dset_id_Z, filespace_Z, hdfier), sphdf5.f90, 666 )
  H5CALL( sphdf5, h5dget_space_f, (dset_id_success, filespace_success, hdfier), sphdf5.f90, 667 )

  H5CALL( sphdf5, h5screate_simple_f, (rankP, length, memspace_t, hdfier), sphdf5.f90, 669 )
  H5CALL( sphdf5, h5screate_simple_f, (rankP, length, memspace_s, hdfier), sphdf5.f90, 670 )
  H5CALL( sphdf5, h5screate_simple_f, (rankP, length, memspace_R, hdfier), sphdf5.f90, 671 )
  H5CALL( sphdf5, h5screate_simple_f, (rankP, length, memspace_Z, hdfier), sphdf5.f90, 672 )
  H5CALL( sphdf5, h5screate_simple_f, (1, int((/ 1 /),HSIZE_T), memspace_success, hdfier), sphdf5.f90, 673 )

  HDEFGRP( file_id, transform, grpTransform )

  H5CALL( sphdf5, h5screate_simple_f, (rankT, int((/           2,Mvol/),HSIZE_T), filespace_diotadxup, hdfier), sphdf5.f90, 677 )
  H5CALL( sphdf5, h5screate_simple_f, (rankT, int((/numTrajTotal,   2/),HSIZE_T), filespace_fiota    , hdfier), sphdf5.f90, 678 )

  H5CALL( sphdf5, h5dcreate_f, (grpTransform, "diotadxup", H5T_NATIVE_DOUBLE, filespace_diotadxup, dset_id_diotadxup, hdfier), sphdf5.f90, 680 )
  H5CALL( sphdf5, h5dcreate_f, (grpTransform,     "fiota", H5T_NATIVE_DOUBLE, filespace_fiota    , dset_id_fiota    , hdfier), sphdf5.f90, 681 )

  H5CALL( sphdf5, h5sclose_f, (filespace_diotadxup, hdfier), sphdf5.f90, 683 )
  H5CALL( sphdf5, h5sclose_f, (filespace_fiota    , hdfier), sphdf5.f90, 684 )

  H5CALL( sphdf5, h5dget_space_f, (dset_id_diotadxup, filespace_diotadxup, hdfier), sphdf5.f90, 686 )
  H5CALL( sphdf5, h5dget_space_f, (dset_id_fiota    , filespace_fiota    , hdfier), sphdf5.f90, 687 )

  H5CALL( sphdf5, h5screate_simple_f, (rankT, int((/2,1/),HSIZE_T), memspace_diotadxup, hdfier), sphdf5.f90, 689 )
...
subroutine write_poincare( offset, data, success )
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  H5CALL( sphdf5, h5sselect_hyperslab_f, (filespace_t, H5S_SELECT_SET_F, int((/0,0,offset/),HSSIZE_T), length, hdfier), sphdf5.f90, 714 )
  H5CALL( sphdf5, h5dwrite_f, (dset_id_t, H5T_NATIVE_DOUBLE, data(1,1:Nz,1:nPpts), dims_singleTraj, hdfier, &
  &               file_space_id=filespace_t, mem_space_id=memspace_t ), sphdf5.f90, 716 )

  H5CALL( sphdf5, h5sselect_hyperslab_f, (filespace_s, H5S_SELECT_SET_F, int((/0,0,offset/),HSSIZE_T), length, hdfier), sphdf5.f90, 718 )
  H5CALL( sphdf5, h5dwrite_f, (dset_id_s, H5T_NATIVE_DOUBLE, data(2,1:Nz,1:nPpts), dims_singleTraj, hdfier, &
  &               file_space_id=filespace_s, mem_space_id=memspace_s ), sphdf5.f90, 720 )

  H5CALL( sphdf5, h5sselect_hyperslab_f, (filespace_R, H5S_SELECT_SET_F, int((/0,0,offset/),HSSIZE_T), length, hdfier), sphdf5.f90, 722 )
  H5CALL( sphdf5, h5dwrite_f, (dset_id_R, H5T_NATIVE_DOUBLE, data(3,1:Nz,1:nPpts), dims_singleTraj, hdfier, &
  &               file_space_id=filespace_R, mem_space_id=memspace_R ), sphdf5.f90, 724 )

  H5CALL( sphdf5, h5sselect_hyperslab_f, (filespace_Z, H5S_SELECT_SET_F, int((/0,0,offset/),HSSIZE_T), length, hdfier), sphdf5.f90, 726 )
  H5CALL( sphdf5, h5dwrite_f, (dset_id_Z, H5T_NATIVE_DOUBLE, data(4,1:Nz,1:nPpts), dims_singleTraj, hdfier, &
  &               file_space_id=filespace_Z, mem_space_id=memspace_Z ), sphdf5.f90, 728 )

  H5CALL( sphdf5, h5sselect_hyperslab_f, (filespace_success, H5S_SELECT_SET_F, int((/offset/),HSSIZE_T), int((/1/), HSIZE_T), hdfier), sphdf5.f90, 730 )
  H5CALL( sphdf5, h5dwrite_f, (dset_id_success, H5T_NATIVE_INTEGER, success, int((/1/), HSIZE_T), hdfier, &
  &               file_space_id=filespace_success, mem_space_id=memspace_success ), sphdf5.f90, 732 )
...
subroutine write_transform( offset, length, lvol, diotadxup, fiota )
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  H5CALL( sphdf5, h5sselect_hyperslab_f, (filespace_diotadxup, H5S_SELECT_SET_F, int((/0,lvol-1/),HSSIZE_T), int((/2,1/),HSSIZE_T), hdfier), sphdf5.f90, 748 )
  H5CALL( sphdf5, h5dwrite_f, (dset_id_diotadxup, H5T_NATIVE_DOUBLE, diotadxup, int((/2,1/),HSSIZE_T), hdfier, &
  &               file_space_id=filespace_diotadxup, mem_space_id=memspace_diotadxup ), sphdf5.f90, 750 )

  H5CALL( sphdf5, h5screate_simple_f, (rankT, int((/length,2/),HSIZE_T), memspace_fiota    , hdfier), sphdf5.f90, 752 )

  H5CALL( sphdf5, h5sselect_hyperslab_f, (filespace_fiota, H5S_SELECT_SET_F, int((/offset,0/),HSSIZE_T), int((/length,2/),HSSIZE_T), hdfier), sphdf5.f90, 754 )
  H5CALL( sphdf5, h5dwrite_f, (dset_id_fiota, H5T_NATIVE_DOUBLE, fiota(1:length,1:2), int((/length,2/),HSSIZE_T), hdfier, &
  &               file_space_id=filespace_fiota, mem_space_id=memspace_fiota ), sphdf5.f90, 756 )

  H5CALL( sphdf5, h5sclose_f, (memspace_fiota, hdfier), sphdf5.f90, 758 )
...
subroutine finalize_flt_output
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  H5CALL( sphdf5, h5sclose_f, (filespace_t,         hdfier), sphdf5.f90, 772 )
  H5CALL( sphdf5, h5sclose_f, (filespace_s,         hdfier), sphdf5.f90, 773 )
  H5CALL( sphdf5, h5sclose_f, (filespace_R,         hdfier), sphdf5.f90, 774 )
  H5CALL( sphdf5, h5sclose_f, (filespace_Z,         hdfier), sphdf5.f90, 775 )
  H5CALL( sphdf5, h5sclose_f, (filespace_success,   hdfier), sphdf5.f90, 776 )
  H5CALL( sphdf5, h5sclose_f, (filespace_diotadxup, hdfier), sphdf5.f90, 777 )
  H5CALL( sphdf5, h5sclose_f, (filespace_fiota,     hdfier), sphdf5.f90, 778 )

  H5CALL( sphdf5, h5sclose_f, (memspace_t,          hdfier), sphdf5.f90, 780 )
  H5CALL( sphdf5, h5sclose_f, (memspace_s,          hdfier), sphdf5.f90, 781 )
  H5CALL( sphdf5, h5sclose_f, (memspace_R,          hdfier), sphdf5.f90, 782 )
  H5CALL( sphdf5, h5sclose_f, (memspace_Z,          hdfier), sphdf5.f90, 783 )
  H5CALL( sphdf5, h5sclose_f, (memspace_success,    hdfier), sphdf5.f90, 784 )
  H5CALL( sphdf5, h5sclose_f, (memspace_diotadxup,  hdfier), sphdf5.f90, 785 )

  H5CALL( sphdf5, h5dclose_f, (dset_id_t,           hdfier), sphdf5.f90, 787 )
  H5CALL( sphdf5, h5dclose_f, (dset_id_s,           hdfier), sphdf5.f90, 788 )
  H5CALL( sphdf5, h5dclose_f, (dset_id_R,           hdfier), sphdf5.f90, 789 )
  H5CALL( sphdf5, h5dclose_f, (dset_id_Z,           hdfier), sphdf5.f90, 790 )
  H5CALL( sphdf5, h5dclose_f, (dset_id_success,     hdfier), sphdf5.f90, 791 )
  H5CALL( sphdf5, h5dclose_f, (dset_id_diotadxup,   hdfier), sphdf5.f90, 792 )
  H5CALL( sphdf5, h5dclose_f, (dset_id_fiota,       hdfier), sphdf5.f90, 793 )
...
subroutine finish_outfile
 ...
 if (myid.eq.0 .and. .not.skip_write) then
  ...
  H5CALL( sphdf5, h5tclose_f, (dt_nDcalls_id, hdfier)    , sphdf5.f90, 955)
  H5CALL( sphdf5, h5tclose_f, (dt_Energy_id, hdfier)     , sphdf5.f90, 956)
  H5CALL( sphdf5, h5tclose_f, (dt_ForceErr_id, hdfier)   , sphdf5.f90, 957)
  H5CALL( sphdf5, h5tclose_f, (dt_iRbc_id, hdfier)       , sphdf5.f90, 958)
  H5CALL( sphdf5, h5tclose_f, (dt_iZbs_id, hdfier)       , sphdf5.f90, 959)
  H5CALL( sphdf5, h5tclose_f, (dt_iRbs_id, hdfier)       , sphdf5.f90, 960)
  H5CALL( sphdf5, h5tclose_f, (dt_iZbc_id, hdfier)       , sphdf5.f90, 961)
  H5CALL( sphdf5, h5dclose_f, (iteration_dset_id, hdfier), sphdf5.f90, 962) ! End access to the dataset and release resources used by it.
  H5CALL( sphdf5, h5pclose_f, (plist_id, hdfier)         , sphdf5.f90, 963) ! close plist used for 'preserve' flag (does not show up in obj_count below)

  H5CALL( sphdf5, h5fget_obj_count_f, (file_id, ior(H5F_OBJ_GROUP_F, ior(H5F_OBJ_DATASET_F, H5F_OBJ_DATATYPE_F)), obj_count, hdfier), sphdf5.f90, 965 )

  if (obj_count.gt.0) then
    write(*,'("There are still ",i3," hdf5 objects open")') obj_count
    allocate(obj_ids(1:obj_count))

    H5CALL( sphdf5, h5fget_obj_ids_f, (file_id, H5F_OBJ_GROUP_F, obj_count, obj_ids, hdfier, num_objs), sphdf5.f90, 971) ! get for open objects
    if (num_objs.gt.0) then
      write(*,'("There are still ",i3," HDF5 groups open:")') num_objs
      do iObj=1,num_objs
        openLength=0
        H5CALL( sphdf5, h5iget_name_f, (obj_ids(iObj), dummyName, dummySize, openLength, hdfier), sphdf5.f90, 976)
        allocate(character(len=openLength+1) :: openName)
        H5CALL( sphdf5, h5iget_name_f, (obj_ids(iObj), openName, openLength, openLength, hdfier), sphdf5.f90, 978)
        write(*,*) openName
        deallocate(openName)

        H5CALL( sphdf5, h5gclose_f, (obj_ids(iObj), hdfier), sphdf5.f90, 982)
      enddo
    endif

    H5CALL( sphdf5, h5fget_obj_ids_f, (file_id, H5F_OBJ_DATASET_F, obj_count, obj_ids, hdfier, num_objs), sphdf5.f90, 986) ! get for open objects
    if (num_objs.gt.0) then
      write(*,'("There are still ",i3," HDF5 datasets open:")') num_objs
      do iObj=1,num_objs
        openLength=0
        H5CALL( sphdf5, h5iget_name_f, (obj_ids(iObj), dummyName, dummySize, openLength, hdfier), sphdf5.f90, 991)
        allocate(character(len=openLength+1) :: openName)
        H5CALL( sphdf5, h5iget_name_f, (obj_ids(iObj), openName, openLength, openLength, hdfier), sphdf5.f90, 993)
        write(*,*) openName(1:openLength)
        deallocate(openName)

        H5CALL( sphdf5, h5dclose_f, (obj_ids(iObj), hdfier), sphdf5.f90, 997)
      enddo
    endif

    H5CALL( sphdf5, h5fget_obj_ids_f, (file_id, H5F_OBJ_DATATYPE_F, obj_count, obj_ids, hdfier, num_objs), sphdf5.f90, 1001) ! get for open objects
    if (num_objs.gt.0) then
      write(*,'("There are still ",i3," HDF5 datatypes open:")') num_objs
      do iObj=1,num_objs
        H5CALL( sphdf5, h5tget_class_f, (obj_ids(iObj), typeClass, hdfier), 1005, sphdf5.f90) ! determine class of open datatype
        ...
        H5CALL( sphdf5, h5tclose_f, (obj_ids(iObj), hdfier), sphdf5.f90, 1020)
      enddo
    endif
  ...
  H5CALL( sphdf5, h5fclose_f, ( file_id, hdfier ), sphdf5.f90, 1027 ) ! terminate access on output file;
  H5CALL( sphdf5, h5close_f,  ( hdfier ),          sphdf5.f90, 1028 ) ! close Fortran interface to the HDF5 library;
