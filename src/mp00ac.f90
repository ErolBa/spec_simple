...
!  !;end select
   ...
   case(1) ! Using direct matrix solver (LU factorization), must not be matrix free
    ...
    case( 0 ) ! ideriv=0;
      ...
      ! open(unit=10, file="."//trim(ext)//".mat.mat", form='unformatted', access='stream')
      ! write(10) matrix
      ! close(10)
      
      ! open(unit=11, file="."//trim(ext)//".mat.rhs", form='unformatted', access='stream')
      ! write(11) rhs(:,0   )
      ! close(11)
      ...
      ! open(unit=11, file="."//trim(ext)//".mat.sol", form='unformatted', access='stream')
      ! write(11) solution(1:NN,0)
      ! close(11)
