...
subroutine curent(lvol, mn, Nt, Nz, iflag, ldItGp)
    ...
    do ideriv = -1, 2 ! labels derivative of magnetic field wrt enclosed fluxes; 20 Apr 13;
        ...
        if (iflag == 1 .and. ideriv /= 0) cycle ! derivatives of currents                                                   are not required; 20 Jun 14;
        if (iflag == 2 .and. ideriv < 0) cycle ! derivatives of currents  wrt geometry                                     is  not required; 20 Jun 14;
        if (iflag == -1 .and. ideriv > 0) cycle ! derivatives of currents  wrt enclosed toroidal and enclosed poloidal flux are not required; 20 Jun 14;
    ...
    do ideriv = -1, 2 ! labels derivative of magnetic field wrt enclosed fluxes; 20 Apr 13;
        ...
        if (ideriv == -1) then ! add derivatives of metrics with respect to interface geometry; 15 Sep 16;
